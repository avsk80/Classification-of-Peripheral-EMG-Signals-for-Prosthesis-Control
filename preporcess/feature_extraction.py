...
def getrmsfeat(data, m, winsize=50, wininc=10):
    result = m.getrmsfeat(data, winsize, wininc)
    return result

def getmavfeat(data, m, winsize=50, wininc=10):
    result = m.getmavfeat(data, winsize, wininc)
    return result

def getzcfeat(data, m, winsize=50, wininc=10, deadzone=0.01):
    result = m.getzcfeat(data, deadzone, winsize, wininc)
    return result

def getsscfeat(data, m, winsize=50, wininc=10, deadzone=0.01):
    result = m.getsscfeat(data, deadzone, winsize, wininc)
    return result

def getwlfeat(data, m, winsize=50, wininc=10):
    result = m.getwlfeat(data, winsize, wininc)
    return result
# (29, 8)

def getarfeat(data, m, winsize=50, wininc=10, ar_order=6):
    result = m.getarfeat(data, ar_order, winsize, wininc)
    return result

def extract_feature(data, m, winsize=50, wininc=10):
    # print("data shape:", np.shape(data))
    feat1 = getrmsfeat(data, m, winsize, wininc)
    min_len = len(feat1)
    # print(np.shape(feat1))
    feat2 = getmavfeat(data, m, winsize, wininc)
    min_len = min(min_len, len(feat2))
    # print(np.shape(feat2))
    feat3 = getzcfeat(data, m, winsize, wininc)
    min_len = min(min_len, len(feat3))
    # print(np.shape(feat3))
    feat4 = getsscfeat(data, m, winsize, wininc)
    min_len = min(min_len, len(feat4))
    # print(np.shape(feat4))
    feat5 = getwlfeat(data, m, winsize, wininc)
    min_len = min(min_len, len(feat5))
    # print(np.shape(feat5))
    feat6 = getarfeat(data, m, winsize, wininc)
